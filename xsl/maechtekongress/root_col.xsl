...
<xsl:stylesheet
    ...
    <xsl:template name="arche_root_col">
        ...
        <xsl:variable name="root_col_node" select="$arche_context//rdf:Description"/>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="lang-de">
                <div class="card-header border-primary">
                    <h1>
                        <xsl:value-of select="$root_col_node/arche:hasTitle[@xml:lang='de']"/>
                    </h1>
                </div>
            ...
            <div class="tab-pane fade" id="lang-en">
                <div class="card-header border-primary">
                    <h1>
                        <xsl:value-of select="$root_col_node/arche:hasTitle[@xml:lang='en']"/>
                    </h1>
                </div>
                <div class="card-body">
                    <p>
